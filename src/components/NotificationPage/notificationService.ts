...
export type Notification = {
  ...
  export const fetchNotifications = async (page: number): Promise<Notification[]> => {
    ...
    const newNotifications = exampleNotifications.map(notification => ({
      ...notification,
      NotificationId: notification.NotificationId + (page - 1) * 10
    }));
