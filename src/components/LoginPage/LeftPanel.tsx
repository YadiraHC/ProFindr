    ...
    return (
        <div className="bg-[#E7F0FA] p-10 h-full flex flex-col justify-between">
            <div className="text-[#0A65CC] w-90 h-90 relative">
                <a href="/"><img src="./images/Logo.png" alt="ProFindr Logo" className="h-10 mb-[3rem]" /></a>
                <h2 className="text-6xl font-medium">Find a job that suits your interest & skills.</h2>
                <p className="mt-3">
